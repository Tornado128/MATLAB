clear;
clc;
cd /home/yaser/Desktop/RESEARCH/BrownianDynamics/oneOrganism1

position=3*importdata('xyzWithOutPBCpuller01.txt');
CoM=importdata('CenterOfMassPositionYASERpuller01.txt');
force   =importdata('forcePULLER01.txt');
i=1;
SD=size(position);
SF=size(force);
j=0;
...
beads=2;
qeqi=qq/(beads-1);
spring=(beads - 1.0)/beads/qeqi/0.05;
